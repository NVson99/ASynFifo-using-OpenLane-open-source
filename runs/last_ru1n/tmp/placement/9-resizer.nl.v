module AsynFifo (empty,
 ...
 sky130_fd_sc_hd__a2111o_1 _0473_ (.A1(_0168_),
    ...
    .D1(_0174_),
    .X(_0175_));
 sky130_fd_sc_hd__buf_6 _0474_ (.A(_0175_),
    .X(_0176_));
 ...
 sky130_fd_sc_hd__o211a_4 _0489_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0189_));
 sky130_fd_sc_hd__mux2_1 _0490_ (.A0(\mem[5][0] ),
    .A1(net4),
    .S(_0189_),
    .X(_0190_));
 sky130_fd_sc_hd__clkbuf_1 _0491_ (.A(_0190_),
    .X(_0000_));
 sky130_fd_sc_hd__mux2_1 _0492_ (.A0(\mem[5][1] ),
    .A1(net5),
    .S(_0189_),
    .X(_0191_));
 sky130_fd_sc_hd__clkbuf_1 _0493_ (.A(_0191_),
    .X(_0001_));
 sky130_fd_sc_hd__mux2_1 _0494_ (.A0(\mem[5][2] ),
    .A1(net6),
    .S(_0189_),
    .X(_0192_));
 sky130_fd_sc_hd__clkbuf_1 _0495_ (.A(_0192_),
    .X(_0002_));
 sky130_fd_sc_hd__mux2_1 _0496_ (.A0(\mem[5][3] ),
    .A1(net7),
    .S(_0189_),
    .X(_0193_));
 sky130_fd_sc_hd__clkbuf_1 _0497_ (.A(_0193_),
    .X(_0003_));
 sky130_fd_sc_hd__mux2_1 _0498_ (.A0(\mem[5][4] ),
    .A1(net8),
    .S(_0189_),
    .X(_0194_));
 sky130_fd_sc_hd__clkbuf_1 _0499_ (.A(_0194_),
    .X(_0004_));
 sky130_fd_sc_hd__mux2_1 _0500_ (.A0(\mem[5][5] ),
    .A1(net9),
    .S(_0189_),
    .X(_0195_));
 sky130_fd_sc_hd__clkbuf_1 _0501_ (.A(_0195_),
    .X(_0005_));
 sky130_fd_sc_hd__mux2_1 _0502_ (.A0(\mem[5][6] ),
    .A1(net10),
    .S(_0189_),
    .X(_0196_));
 sky130_fd_sc_hd__clkbuf_1 _0503_ (.A(_0196_),
    .X(_0006_));
 sky130_fd_sc_hd__mux2_1 _0504_ (.A0(\mem[5][7] ),
    .A1(net11),
    .S(_0189_),
    .X(_0197_));
 sky130_fd_sc_hd__clkbuf_1 _0505_ (.A(_0197_),
    .X(_0007_));
 sky130_fd_sc_hd__buf_6 _0506_ (.A(\r_ptr_b[0] ),
    .X(_0198_));
 sky130_fd_sc_hd__clkbuf_8 _0507_ (.A(\r_ptr_b[1] ),
    .X(_0199_));
 ...
 sky130_fd_sc_hd__inv_2 _0510_ (.A(\r_ptr_b[2] ),
    .Y(_0202_));
 sky130_fd_sc_hd__buf_6 _0511_ (.A(_0202_),
    .X(_0203_));
 ...
 sky130_fd_sc_hd__mux2_1 _0517_ (.A0(_0207_),
    ...
    .S(_0203_),
    .X(_0209_));
 sky130_fd_sc_hd__buf_4 _0518_ (.A(\r_ptr_b[3] ),
    .X(_0210_));
 ...
 sky130_fd_sc_hd__o211a_4 _0587_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0271_));
 sky130_fd_sc_hd__mux2_1 _0588_ (.A0(\mem[14][0] ),
    .A1(net4),
    .S(_0271_),
    .X(_0272_));
 sky130_fd_sc_hd__clkbuf_1 _0589_ (.A(_0272_),
    .X(_0016_));
 sky130_fd_sc_hd__mux2_1 _0590_ (.A0(\mem[14][1] ),
    .A1(net5),
    .S(_0271_),
    .X(_0273_));
 sky130_fd_sc_hd__clkbuf_1 _0591_ (.A(_0273_),
    .X(_0017_));
 sky130_fd_sc_hd__mux2_1 _0592_ (.A0(\mem[14][2] ),
    .A1(net6),
    .S(_0271_),
    .X(_0274_));
 sky130_fd_sc_hd__clkbuf_1 _0593_ (.A(_0274_),
    .X(_0018_));
 sky130_fd_sc_hd__mux2_1 _0594_ (.A0(\mem[14][3] ),
    .A1(net7),
    .S(_0271_),
    .X(_0275_));
 sky130_fd_sc_hd__clkbuf_1 _0595_ (.A(_0275_),
    .X(_0019_));
 sky130_fd_sc_hd__mux2_1 _0596_ (.A0(\mem[14][4] ),
    .A1(net8),
    .S(_0271_),
    .X(_0276_));
 sky130_fd_sc_hd__clkbuf_1 _0597_ (.A(_0276_),
    .X(_0020_));
 sky130_fd_sc_hd__mux2_1 _0598_ (.A0(\mem[14][5] ),
    .A1(net9),
    .S(_0271_),
    .X(_0277_));
 sky130_fd_sc_hd__clkbuf_1 _0599_ (.A(_0277_),
    .X(_0021_));
 sky130_fd_sc_hd__mux2_1 _0600_ (.A0(\mem[14][6] ),
    .A1(net10),
    .S(_0271_),
    .X(_0278_));
 sky130_fd_sc_hd__clkbuf_1 _0601_ (.A(_0278_),
    .X(_0022_));
 sky130_fd_sc_hd__mux2_1 _0602_ (.A0(\mem[14][7] ),
    .A1(net11),
    .S(_0271_),
    .X(_0279_));
 ...
 sky130_fd_sc_hd__o211a_4 _0606_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0282_));
 sky130_fd_sc_hd__mux2_1 _0607_ (.A0(\mem[1][0] ),
    .A1(net4),
    .S(_0282_),
    .X(_0283_));
 sky130_fd_sc_hd__clkbuf_1 _0608_ (.A(_0283_),
    .X(_0024_));
 sky130_fd_sc_hd__mux2_1 _0609_ (.A0(\mem[1][1] ),
    .A1(net5),
    .S(_0282_),
    .X(_0284_));
 sky130_fd_sc_hd__clkbuf_1 _0610_ (.A(_0284_),
    .X(_0025_));
 sky130_fd_sc_hd__mux2_1 _0611_ (.A0(\mem[1][2] ),
    .A1(net6),
    .S(_0282_),
    .X(_0285_));
 sky130_fd_sc_hd__clkbuf_1 _0612_ (.A(_0285_),
    .X(_0026_));
 sky130_fd_sc_hd__mux2_1 _0613_ (.A0(\mem[1][3] ),
    .A1(net7),
    .S(_0282_),
    .X(_0286_));
 sky130_fd_sc_hd__clkbuf_1 _0614_ (.A(_0286_),
    .X(_0027_));
 sky130_fd_sc_hd__mux2_1 _0615_ (.A0(\mem[1][4] ),
    .A1(net8),
    .S(_0282_),
    .X(_0287_));
 sky130_fd_sc_hd__clkbuf_1 _0616_ (.A(_0287_),
    .X(_0028_));
 sky130_fd_sc_hd__mux2_1 _0617_ (.A0(\mem[1][5] ),
    .A1(net9),
    .S(_0282_),
    .X(_0288_));
 sky130_fd_sc_hd__clkbuf_1 _0618_ (.A(_0288_),
    .X(_0029_));
 sky130_fd_sc_hd__mux2_1 _0619_ (.A0(\mem[1][6] ),
    .A1(net10),
    .S(_0282_),
    .X(_0289_));
 sky130_fd_sc_hd__clkbuf_1 _0620_ (.A(_0289_),
    .X(_0030_));
 sky130_fd_sc_hd__mux2_1 _0621_ (.A0(\mem[1][7] ),
    .A1(net11),
    .S(_0282_),
    .X(_0290_));
 ...
 sky130_fd_sc_hd__o211a_4 _0624_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0292_));
 sky130_fd_sc_hd__mux2_1 _0625_ (.A0(\mem[13][0] ),
    .A1(net4),
    .S(_0292_),
    .X(_0293_));
 sky130_fd_sc_hd__clkbuf_1 _0626_ (.A(_0293_),
    .X(_0032_));
 sky130_fd_sc_hd__mux2_1 _0627_ (.A0(\mem[13][1] ),
    .A1(net5),
    .S(_0292_),
    .X(_0294_));
 sky130_fd_sc_hd__clkbuf_1 _0628_ (.A(_0294_),
    .X(_0033_));
 sky130_fd_sc_hd__mux2_1 _0629_ (.A0(\mem[13][2] ),
    .A1(net6),
    .S(_0292_),
    .X(_0295_));
 sky130_fd_sc_hd__clkbuf_1 _0630_ (.A(_0295_),
    .X(_0034_));
 sky130_fd_sc_hd__mux2_1 _0631_ (.A0(\mem[13][3] ),
    .A1(net7),
    .S(_0292_),
    .X(_0296_));
 sky130_fd_sc_hd__clkbuf_1 _0632_ (.A(_0296_),
    .X(_0035_));
 sky130_fd_sc_hd__mux2_1 _0633_ (.A0(\mem[13][4] ),
    .A1(net8),
    .S(_0292_),
    .X(_0297_));
 sky130_fd_sc_hd__clkbuf_1 _0634_ (.A(_0297_),
    .X(_0036_));
 sky130_fd_sc_hd__mux2_1 _0635_ (.A0(\mem[13][5] ),
    .A1(net9),
    .S(_0292_),
    .X(_0298_));
 sky130_fd_sc_hd__clkbuf_1 _0636_ (.A(_0298_),
    .X(_0037_));
 sky130_fd_sc_hd__mux2_1 _0637_ (.A0(\mem[13][6] ),
    .A1(net10),
    .S(_0292_),
    .X(_0299_));
 sky130_fd_sc_hd__clkbuf_1 _0638_ (.A(_0299_),
    .X(_0038_));
 sky130_fd_sc_hd__mux2_1 _0639_ (.A0(\mem[13][7] ),
    .A1(net11),
    .S(_0292_),
    .X(_0300_));
 ...
 sky130_fd_sc_hd__o211a_4 _0642_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0302_));
 sky130_fd_sc_hd__mux2_1 _0643_ (.A0(\mem[12][0] ),
    .A1(net4),
    .S(_0302_),
    .X(_0303_));
 sky130_fd_sc_hd__clkbuf_1 _0644_ (.A(_0303_),
    .X(_0040_));
 sky130_fd_sc_hd__mux2_1 _0645_ (.A0(\mem[12][1] ),
    .A1(net5),
    .S(_0302_),
    .X(_0304_));
 sky130_fd_sc_hd__clkbuf_1 _0646_ (.A(_0304_),
    .X(_0041_));
 sky130_fd_sc_hd__mux2_1 _0647_ (.A0(\mem[12][2] ),
    .A1(net6),
    .S(_0302_),
    .X(_0305_));
 sky130_fd_sc_hd__clkbuf_1 _0648_ (.A(_0305_),
    .X(_0042_));
 sky130_fd_sc_hd__mux2_1 _0649_ (.A0(\mem[12][3] ),
    .A1(net7),
    .S(_0302_),
    .X(_0306_));
 sky130_fd_sc_hd__clkbuf_1 _0650_ (.A(_0306_),
    .X(_0043_));
 sky130_fd_sc_hd__mux2_1 _0651_ (.A0(\mem[12][4] ),
    .A1(net8),
    .S(_0302_),
    .X(_0307_));
 sky130_fd_sc_hd__clkbuf_1 _0652_ (.A(_0307_),
    .X(_0044_));
 sky130_fd_sc_hd__mux2_1 _0653_ (.A0(\mem[12][5] ),
    .A1(net9),
    .S(_0302_),
    .X(_0308_));
 sky130_fd_sc_hd__clkbuf_1 _0654_ (.A(_0308_),
    .X(_0045_));
 sky130_fd_sc_hd__mux2_1 _0655_ (.A0(\mem[12][6] ),
    .A1(net10),
    .S(_0302_),
    .X(_0309_));
 sky130_fd_sc_hd__clkbuf_1 _0656_ (.A(_0309_),
    .X(_0046_));
 sky130_fd_sc_hd__mux2_1 _0657_ (.A0(\mem[12][7] ),
    .A1(net11),
    .S(_0302_),
    .X(_0310_));
 ...
 sky130_fd_sc_hd__o211a_4 _0660_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0312_));
 sky130_fd_sc_hd__mux2_1 _0661_ (.A0(\mem[11][0] ),
    .A1(net4),
    .S(_0312_),
    .X(_0313_));
 sky130_fd_sc_hd__clkbuf_1 _0662_ (.A(_0313_),
    .X(_0048_));
 sky130_fd_sc_hd__mux2_1 _0663_ (.A0(\mem[11][1] ),
    .A1(net5),
    .S(_0312_),
    .X(_0314_));
 sky130_fd_sc_hd__clkbuf_1 _0664_ (.A(_0314_),
    .X(_0049_));
 sky130_fd_sc_hd__mux2_1 _0665_ (.A0(\mem[11][2] ),
    .A1(net6),
    .S(_0312_),
    .X(_0315_));
 sky130_fd_sc_hd__clkbuf_1 _0666_ (.A(_0315_),
    .X(_0050_));
 sky130_fd_sc_hd__mux2_1 _0667_ (.A0(\mem[11][3] ),
    .A1(net7),
    .S(_0312_),
    .X(_0316_));
 sky130_fd_sc_hd__clkbuf_1 _0668_ (.A(_0316_),
    .X(_0051_));
 sky130_fd_sc_hd__mux2_1 _0669_ (.A0(\mem[11][4] ),
    .A1(net8),
    .S(_0312_),
    .X(_0317_));
 sky130_fd_sc_hd__clkbuf_1 _0670_ (.A(_0317_),
    .X(_0052_));
 sky130_fd_sc_hd__mux2_1 _0671_ (.A0(\mem[11][5] ),
    .A1(net9),
    .S(_0312_),
    .X(_0318_));
 sky130_fd_sc_hd__clkbuf_1 _0672_ (.A(_0318_),
    .X(_0053_));
 sky130_fd_sc_hd__mux2_1 _0673_ (.A0(\mem[11][6] ),
    .A1(net10),
    .S(_0312_),
    .X(_0319_));
 sky130_fd_sc_hd__clkbuf_1 _0674_ (.A(_0319_),
    .X(_0054_));
 sky130_fd_sc_hd__mux2_1 _0675_ (.A0(\mem[11][7] ),
    .A1(net11),
    .S(_0312_),
    .X(_0320_));
 ...
 sky130_fd_sc_hd__o211a_4 _0680_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0324_));
 sky130_fd_sc_hd__mux2_1 _0681_ (.A0(\mem[10][0] ),
    .A1(net4),
    .S(_0324_),
    .X(_0325_));
 sky130_fd_sc_hd__clkbuf_1 _0682_ (.A(_0325_),
    .X(_0056_));
 sky130_fd_sc_hd__mux2_1 _0683_ (.A0(\mem[10][1] ),
    .A1(net5),
    .S(_0324_),
    .X(_0326_));
 sky130_fd_sc_hd__clkbuf_1 _0684_ (.A(_0326_),
    .X(_0057_));
 sky130_fd_sc_hd__mux2_1 _0685_ (.A0(\mem[10][2] ),
    .A1(net6),
    .S(_0324_),
    .X(_0327_));
 sky130_fd_sc_hd__clkbuf_1 _0686_ (.A(_0327_),
    .X(_0058_));
 sky130_fd_sc_hd__mux2_1 _0687_ (.A0(\mem[10][3] ),
    .A1(net7),
    .S(_0324_),
    .X(_0328_));
 sky130_fd_sc_hd__clkbuf_1 _0688_ (.A(_0328_),
    .X(_0059_));
 sky130_fd_sc_hd__mux2_1 _0689_ (.A0(\mem[10][4] ),
    .A1(net8),
    .S(_0324_),
    .X(_0329_));
 sky130_fd_sc_hd__clkbuf_1 _0690_ (.A(_0329_),
    .X(_0060_));
 sky130_fd_sc_hd__mux2_1 _0691_ (.A0(\mem[10][5] ),
    .A1(net9),
    .S(_0324_),
    .X(_0330_));
 sky130_fd_sc_hd__clkbuf_1 _0692_ (.A(_0330_),
    .X(_0061_));
 sky130_fd_sc_hd__mux2_1 _0693_ (.A0(\mem[10][6] ),
    .A1(net10),
    .S(_0324_),
    .X(_0331_));
 sky130_fd_sc_hd__clkbuf_1 _0694_ (.A(_0331_),
    .X(_0062_));
 sky130_fd_sc_hd__mux2_1 _0695_ (.A0(\mem[10][7] ),
    .A1(net11),
    .S(_0324_),
    .X(_0332_));
 ...
 sky130_fd_sc_hd__o211a_4 _0699_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0335_));
 sky130_fd_sc_hd__mux2_1 _0700_ (.A0(\mem[0][0] ),
    .A1(net4),
    .S(_0335_),
    .X(_0336_));
 sky130_fd_sc_hd__clkbuf_1 _0701_ (.A(_0336_),
    .X(_0064_));
 sky130_fd_sc_hd__mux2_1 _0702_ (.A0(\mem[0][1] ),
    .A1(net5),
    .S(_0335_),
    .X(_0337_));
 sky130_fd_sc_hd__clkbuf_1 _0703_ (.A(_0337_),
    .X(_0065_));
 sky130_fd_sc_hd__mux2_1 _0704_ (.A0(\mem[0][2] ),
    .A1(net6),
    .S(_0335_),
    .X(_0338_));
 sky130_fd_sc_hd__clkbuf_1 _0705_ (.A(_0338_),
    .X(_0066_));
 sky130_fd_sc_hd__mux2_1 _0706_ (.A0(\mem[0][3] ),
    .A1(net7),
    .S(_0335_),
    .X(_0339_));
 sky130_fd_sc_hd__clkbuf_1 _0707_ (.A(_0339_),
    .X(_0067_));
 sky130_fd_sc_hd__mux2_1 _0708_ (.A0(\mem[0][4] ),
    .A1(net8),
    .S(_0335_),
    .X(_0340_));
 sky130_fd_sc_hd__clkbuf_1 _0709_ (.A(_0340_),
    .X(_0068_));
 sky130_fd_sc_hd__mux2_1 _0710_ (.A0(\mem[0][5] ),
    .A1(net9),
    .S(_0335_),
    .X(_0341_));
 sky130_fd_sc_hd__clkbuf_1 _0711_ (.A(_0341_),
    .X(_0069_));
 sky130_fd_sc_hd__mux2_1 _0712_ (.A0(\mem[0][6] ),
    .A1(net10),
    .S(_0335_),
    .X(_0342_));
 sky130_fd_sc_hd__clkbuf_1 _0713_ (.A(_0342_),
    .X(_0070_));
 sky130_fd_sc_hd__mux2_1 _0714_ (.A0(\mem[0][7] ),
    .A1(net11),
    .S(_0335_),
    .X(_0343_));
 ...
 sky130_fd_sc_hd__o211a_4 _0717_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0345_));
 sky130_fd_sc_hd__mux2_1 _0718_ (.A0(\mem[2][0] ),
    .A1(net4),
    .S(_0345_),
    .X(_0346_));
 sky130_fd_sc_hd__clkbuf_1 _0719_ (.A(_0346_),
    .X(_0072_));
 sky130_fd_sc_hd__mux2_1 _0720_ (.A0(\mem[2][1] ),
    .A1(net5),
    .S(_0345_),
    .X(_0347_));
 sky130_fd_sc_hd__clkbuf_1 _0721_ (.A(_0347_),
    .X(_0073_));
 sky130_fd_sc_hd__mux2_1 _0722_ (.A0(\mem[2][2] ),
    .A1(net6),
    .S(_0345_),
    .X(_0348_));
 sky130_fd_sc_hd__clkbuf_1 _0723_ (.A(_0348_),
    .X(_0074_));
 sky130_fd_sc_hd__mux2_1 _0724_ (.A0(\mem[2][3] ),
    .A1(net7),
    .S(_0345_),
    .X(_0349_));
 sky130_fd_sc_hd__clkbuf_1 _0725_ (.A(_0349_),
    .X(_0075_));
 sky130_fd_sc_hd__mux2_1 _0726_ (.A0(\mem[2][4] ),
    .A1(net8),
    .S(_0345_),
    .X(_0350_));
 sky130_fd_sc_hd__clkbuf_1 _0727_ (.A(_0350_),
    .X(_0076_));
 sky130_fd_sc_hd__mux2_1 _0728_ (.A0(\mem[2][5] ),
    .A1(net9),
    .S(_0345_),
    .X(_0351_));
 sky130_fd_sc_hd__clkbuf_1 _0729_ (.A(_0351_),
    .X(_0077_));
 sky130_fd_sc_hd__mux2_1 _0730_ (.A0(\mem[2][6] ),
    .A1(net10),
    .S(_0345_),
    .X(_0352_));
 sky130_fd_sc_hd__clkbuf_1 _0731_ (.A(_0352_),
    .X(_0078_));
 sky130_fd_sc_hd__mux2_1 _0732_ (.A0(\mem[2][7] ),
    .A1(net11),
    .S(_0345_),
    .X(_0353_));
 ...
 sky130_fd_sc_hd__o211a_4 _0735_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0355_));
 sky130_fd_sc_hd__mux2_1 _0736_ (.A0(\mem[8][0] ),
    .A1(net4),
    .S(_0355_),
    .X(_0356_));
 sky130_fd_sc_hd__clkbuf_1 _0737_ (.A(_0356_),
    .X(_0080_));
 sky130_fd_sc_hd__mux2_1 _0738_ (.A0(\mem[8][1] ),
    .A1(net5),
    .S(_0355_),
    .X(_0357_));
 sky130_fd_sc_hd__clkbuf_1 _0739_ (.A(_0357_),
    .X(_0081_));
 sky130_fd_sc_hd__mux2_1 _0740_ (.A0(\mem[8][2] ),
    .A1(net6),
    .S(_0355_),
    .X(_0358_));
 sky130_fd_sc_hd__clkbuf_1 _0741_ (.A(_0358_),
    .X(_0082_));
 sky130_fd_sc_hd__mux2_1 _0742_ (.A0(\mem[8][3] ),
    .A1(net7),
    .S(_0355_),
    .X(_0359_));
 sky130_fd_sc_hd__clkbuf_1 _0743_ (.A(_0359_),
    .X(_0083_));
 sky130_fd_sc_hd__mux2_1 _0744_ (.A0(\mem[8][4] ),
    .A1(net8),
    .S(_0355_),
    .X(_0360_));
 sky130_fd_sc_hd__clkbuf_1 _0745_ (.A(_0360_),
    .X(_0084_));
 sky130_fd_sc_hd__mux2_1 _0746_ (.A0(\mem[8][5] ),
    .A1(net9),
    .S(_0355_),
    .X(_0361_));
 sky130_fd_sc_hd__clkbuf_1 _0747_ (.A(_0361_),
    .X(_0085_));
 sky130_fd_sc_hd__mux2_1 _0748_ (.A0(\mem[8][6] ),
    .A1(net10),
    .S(_0355_),
    .X(_0362_));
 sky130_fd_sc_hd__clkbuf_1 _0749_ (.A(_0362_),
    .X(_0086_));
 sky130_fd_sc_hd__mux2_1 _0750_ (.A0(\mem[8][7] ),
    .A1(net11),
    .S(_0355_),
    .X(_0363_));
 ...
 sky130_fd_sc_hd__o2111a_4 _0752_ (.A1(_0162_),
    ...
    .D1(_0159_),
    .X(_0364_));
 sky130_fd_sc_hd__mux2_1 _0753_ (.A0(\mem[7][0] ),
    .A1(net4),
    .S(_0364_),
    .X(_0365_));
 sky130_fd_sc_hd__clkbuf_1 _0754_ (.A(_0365_),
    .X(_0088_));
 sky130_fd_sc_hd__mux2_1 _0755_ (.A0(\mem[7][1] ),
    .A1(net5),
    .S(_0364_),
    .X(_0366_));
 sky130_fd_sc_hd__clkbuf_1 _0756_ (.A(_0366_),
    .X(_0089_));
 sky130_fd_sc_hd__mux2_1 _0757_ (.A0(\mem[7][2] ),
    .A1(net6),
    .S(_0364_),
    .X(_0367_));
 sky130_fd_sc_hd__clkbuf_1 _0758_ (.A(_0367_),
    .X(_0090_));
 sky130_fd_sc_hd__mux2_1 _0759_ (.A0(\mem[7][3] ),
    .A1(net7),
    .S(_0364_),
    .X(_0368_));
 sky130_fd_sc_hd__clkbuf_1 _0760_ (.A(_0368_),
    .X(_0091_));
 sky130_fd_sc_hd__mux2_1 _0761_ (.A0(\mem[7][4] ),
    .A1(net8),
    .S(_0364_),
    .X(_0369_));
 sky130_fd_sc_hd__clkbuf_1 _0762_ (.A(_0369_),
    .X(_0092_));
 sky130_fd_sc_hd__mux2_1 _0763_ (.A0(\mem[7][5] ),
    .A1(net9),
    .S(_0364_),
    .X(_0370_));
 sky130_fd_sc_hd__clkbuf_1 _0764_ (.A(_0370_),
    .X(_0093_));
 sky130_fd_sc_hd__mux2_1 _0765_ (.A0(\mem[7][6] ),
    .A1(net10),
    .S(_0364_),
    .X(_0371_));
 sky130_fd_sc_hd__clkbuf_1 _0766_ (.A(_0371_),
    .X(_0094_));
 sky130_fd_sc_hd__mux2_1 _0767_ (.A0(\mem[7][7] ),
    .A1(net11),
    .S(_0364_),
    .X(_0372_));
 ...
 sky130_fd_sc_hd__o211a_4 _0770_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0374_));
 sky130_fd_sc_hd__mux2_1 _0771_ (.A0(\mem[3][0] ),
    .A1(net4),
    .S(_0374_),
    .X(_0375_));
 sky130_fd_sc_hd__clkbuf_1 _0772_ (.A(_0375_),
    .X(_0096_));
 sky130_fd_sc_hd__mux2_1 _0773_ (.A0(\mem[3][1] ),
    .A1(net5),
    .S(_0374_),
    .X(_0376_));
 sky130_fd_sc_hd__clkbuf_1 _0774_ (.A(_0376_),
    .X(_0097_));
 sky130_fd_sc_hd__mux2_1 _0775_ (.A0(\mem[3][2] ),
    .A1(net6),
    .S(_0374_),
    .X(_0377_));
 sky130_fd_sc_hd__clkbuf_1 _0776_ (.A(_0377_),
    .X(_0098_));
 sky130_fd_sc_hd__mux2_1 _0777_ (.A0(\mem[3][3] ),
    .A1(net7),
    .S(_0374_),
    .X(_0378_));
 sky130_fd_sc_hd__clkbuf_1 _0778_ (.A(_0378_),
    .X(_0099_));
 sky130_fd_sc_hd__mux2_1 _0779_ (.A0(\mem[3][4] ),
    .A1(net8),
    .S(_0374_),
    .X(_0379_));
 sky130_fd_sc_hd__clkbuf_1 _0780_ (.A(_0379_),
    .X(_0100_));
 sky130_fd_sc_hd__mux2_1 _0781_ (.A0(\mem[3][5] ),
    .A1(net9),
    .S(_0374_),
    .X(_0380_));
 sky130_fd_sc_hd__clkbuf_1 _0782_ (.A(_0380_),
    .X(_0101_));
 sky130_fd_sc_hd__mux2_1 _0783_ (.A0(\mem[3][6] ),
    .A1(net10),
    .S(_0374_),
    .X(_0381_));
 sky130_fd_sc_hd__clkbuf_1 _0784_ (.A(_0381_),
    .X(_0102_));
 sky130_fd_sc_hd__mux2_1 _0785_ (.A0(\mem[3][7] ),
    .A1(net11),
    .S(_0374_),
    .X(_0382_));
 ...
 sky130_fd_sc_hd__o211a_4 _0788_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0384_));
 sky130_fd_sc_hd__mux2_1 _0789_ (.A0(\mem[6][0] ),
    .A1(net4),
    .S(_0384_),
    .X(_0385_));
 sky130_fd_sc_hd__clkbuf_1 _0790_ (.A(_0385_),
    .X(_0104_));
 sky130_fd_sc_hd__mux2_1 _0791_ (.A0(\mem[6][1] ),
    .A1(net5),
    .S(_0384_),
    .X(_0386_));
 sky130_fd_sc_hd__clkbuf_1 _0792_ (.A(_0386_),
    .X(_0105_));
 sky130_fd_sc_hd__mux2_1 _0793_ (.A0(\mem[6][2] ),
    .A1(net6),
    .S(_0384_),
    .X(_0387_));
 sky130_fd_sc_hd__clkbuf_1 _0794_ (.A(_0387_),
    .X(_0106_));
 sky130_fd_sc_hd__mux2_1 _0795_ (.A0(\mem[6][3] ),
    .A1(net7),
    .S(_0384_),
    .X(_0388_));
 sky130_fd_sc_hd__clkbuf_1 _0796_ (.A(_0388_),
    .X(_0107_));
 sky130_fd_sc_hd__mux2_1 _0797_ (.A0(\mem[6][4] ),
    .A1(net8),
    .S(_0384_),
    .X(_0389_));
 sky130_fd_sc_hd__clkbuf_1 _0798_ (.A(_0389_),
    .X(_0108_));
 sky130_fd_sc_hd__mux2_1 _0799_ (.A0(\mem[6][5] ),
    .A1(net9),
    .S(_0384_),
    .X(_0390_));
 sky130_fd_sc_hd__clkbuf_1 _0800_ (.A(_0390_),
    .X(_0109_));
 sky130_fd_sc_hd__mux2_1 _0801_ (.A0(\mem[6][6] ),
    .A1(net10),
    .S(_0384_),
    .X(_0391_));
 sky130_fd_sc_hd__clkbuf_1 _0802_ (.A(_0391_),
    .X(_0110_));
 sky130_fd_sc_hd__mux2_1 _0803_ (.A0(\mem[6][7] ),
    .A1(net11),
    .S(_0384_),
    .X(_0392_));
 ...
 sky130_fd_sc_hd__o21a_4 _0805_ (.A1(_0163_),
    ...
    .B1(_0188_),
    .X(_0393_));
 sky130_fd_sc_hd__mux2_1 _0806_ (.A0(\w_ptr_g[0] ),
    .A1(_0184_),
    .S(_0393_),
    .X(_0394_));
 ...
 sky130_fd_sc_hd__nand2_1 _0808_ (.A(_0166_),
    .B(_0167_),
    .Y(_0395_));
 sky130_fd_sc_hd__mux2_1 _0809_ (.A0(\w_ptr_g[1] ),
    .A1(_0395_),
    .S(_0393_),
    .X(_0396_));
 ...
 sky130_fd_sc_hd__o211a_1 _0811_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0397_));
 sky130_fd_sc_hd__o21ba_1 _0812_ (.A1(\w_ptr_g[2] ),
    .A2(_0393_),
    .B1_N(_0397_),
    .X(_0114_));
 sky130_fd_sc_hd__mux2_1 _0813_ (.A0(\w_ptr_g[3] ),
    .A1(_0161_),
    .S(_0393_),
    .X(_0398_));
 ...
 sky130_fd_sc_hd__o211a_4 _0818_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0401_));
 sky130_fd_sc_hd__mux2_1 _0819_ (.A0(\mem[4][0] ),
    .A1(net4),
    .S(_0401_),
    .X(_0402_));
 sky130_fd_sc_hd__clkbuf_1 _0820_ (.A(_0402_),
    .X(_0117_));
 sky130_fd_sc_hd__mux2_1 _0821_ (.A0(\mem[4][1] ),
    .A1(net5),
    .S(_0401_),
    .X(_0403_));
 sky130_fd_sc_hd__clkbuf_1 _0822_ (.A(_0403_),
    .X(_0118_));
 sky130_fd_sc_hd__mux2_1 _0823_ (.A0(\mem[4][2] ),
    .A1(net6),
    .S(_0401_),
    .X(_0404_));
 sky130_fd_sc_hd__clkbuf_1 _0824_ (.A(_0404_),
    .X(_0119_));
 sky130_fd_sc_hd__mux2_1 _0825_ (.A0(\mem[4][3] ),
    .A1(net7),
    .S(_0401_),
    .X(_0405_));
 sky130_fd_sc_hd__clkbuf_1 _0826_ (.A(_0405_),
    .X(_0120_));
 sky130_fd_sc_hd__mux2_1 _0827_ (.A0(\mem[4][4] ),
    .A1(net8),
    .S(_0401_),
    .X(_0406_));
 sky130_fd_sc_hd__clkbuf_1 _0828_ (.A(_0406_),
    .X(_0121_));
 sky130_fd_sc_hd__mux2_1 _0829_ (.A0(\mem[4][5] ),
    .A1(net9),
    .S(_0401_),
    .X(_0407_));
 sky130_fd_sc_hd__clkbuf_1 _0830_ (.A(_0407_),
    .X(_0122_));
 sky130_fd_sc_hd__mux2_1 _0831_ (.A0(\mem[4][6] ),
    .A1(net10),
    .S(_0401_),
    .X(_0408_));
 sky130_fd_sc_hd__clkbuf_1 _0832_ (.A(_0408_),
    .X(_0123_));
 sky130_fd_sc_hd__mux2_1 _0833_ (.A0(\mem[4][7] ),
    .A1(net11),
    .S(_0401_),
    .X(_0409_));
 ...
 sky130_fd_sc_hd__o211a_4 _0871_ (.A1(_0163_),
    ...
    .C1(_0156_),
    .X(_0433_));
 sky130_fd_sc_hd__mux2_1 _0872_ (.A0(\mem[15][0] ),
    .A1(net4),
    .S(_0433_),
    .X(_0434_));
 sky130_fd_sc_hd__clkbuf_1 _0873_ (.A(_0434_),
    .X(_0138_));
 sky130_fd_sc_hd__mux2_1 _0874_ (.A0(\mem[15][1] ),
    .A1(net5),
    .S(_0433_),
    .X(_0435_));
 sky130_fd_sc_hd__clkbuf_1 _0875_ (.A(_0435_),
    .X(_0139_));
 sky130_fd_sc_hd__mux2_1 _0876_ (.A0(\mem[15][2] ),
    .A1(net6),
    .S(_0433_),
    .X(_0436_));
 sky130_fd_sc_hd__clkbuf_1 _0877_ (.A(_0436_),
    .X(_0140_));
 sky130_fd_sc_hd__mux2_1 _0878_ (.A0(\mem[15][3] ),
    .A1(net7),
    .S(_0433_),
    .X(_0437_));
 sky130_fd_sc_hd__clkbuf_1 _0879_ (.A(_0437_),
    .X(_0141_));
 sky130_fd_sc_hd__mux2_1 _0880_ (.A0(\mem[15][4] ),
    .A1(net8),
    .S(_0433_),
    .X(_0438_));
 sky130_fd_sc_hd__clkbuf_1 _0881_ (.A(_0438_),
    .X(_0142_));
 sky130_fd_sc_hd__mux2_1 _0882_ (.A0(\mem[15][5] ),
    .A1(net9),
    .S(_0433_),
    .X(_0439_));
 sky130_fd_sc_hd__clkbuf_1 _0883_ (.A(_0439_),
    .X(_0143_));
 sky130_fd_sc_hd__mux2_1 _0884_ (.A0(\mem[15][6] ),
    .A1(net10),
    .S(_0433_),
    .X(_0440_));
 sky130_fd_sc_hd__clkbuf_1 _0885_ (.A(_0440_),
    .X(_0144_));
 sky130_fd_sc_hd__mux2_1 _0886_ (.A0(\mem[15][7] ),
    .A1(net11),
    .S(_0433_),
    .X(_0441_));
 ...
 sky130_fd_sc_hd__o211a_4 _0889_ (.A1(_0163_),
    ...
    .C1(_0188_),
    .X(_0443_));
 sky130_fd_sc_hd__mux2_1 _0890_ (.A0(\mem[9][0] ),
    .A1(net4),
    .S(_0443_),
    .X(_0444_));
 sky130_fd_sc_hd__clkbuf_1 _0891_ (.A(_0444_),
    .X(_0146_));
 sky130_fd_sc_hd__mux2_1 _0892_ (.A0(\mem[9][1] ),
    .A1(net5),
    .S(_0443_),
    .X(_0445_));
 sky130_fd_sc_hd__clkbuf_1 _0893_ (.A(_0445_),
    .X(_0147_));
 sky130_fd_sc_hd__mux2_1 _0894_ (.A0(\mem[9][2] ),
    .A1(net6),
    .S(_0443_),
    .X(_0446_));
 sky130_fd_sc_hd__clkbuf_1 _0895_ (.A(_0446_),
    .X(_0148_));
 sky130_fd_sc_hd__mux2_1 _0896_ (.A0(\mem[9][3] ),
    .A1(net7),
    .S(_0443_),
    .X(_0447_));
 sky130_fd_sc_hd__clkbuf_1 _0897_ (.A(_0447_),
    .X(_0149_));
 sky130_fd_sc_hd__mux2_1 _0898_ (.A0(\mem[9][4] ),
    .A1(net8),
    .S(_0443_),
    .X(_0448_));
 sky130_fd_sc_hd__clkbuf_1 _0899_ (.A(_0448_),
    .X(_0150_));
 sky130_fd_sc_hd__mux2_1 _0900_ (.A0(\mem[9][5] ),
    .A1(net9),
    .S(_0443_),
    .X(_0449_));
 sky130_fd_sc_hd__clkbuf_1 _0901_ (.A(_0449_),
    .X(_0151_));
 sky130_fd_sc_hd__mux2_1 _0902_ (.A0(\mem[9][6] ),
    .A1(net10),
    .S(_0443_),
    .X(_0450_));
 sky130_fd_sc_hd__clkbuf_1 _0903_ (.A(_0450_),
    .X(_0152_));
 sky130_fd_sc_hd__mux2_1 _0904_ (.A0(\mem[9][7] ),
    .A1(net11),
    .S(_0443_),
    .X(_0451_));
 sky130_fd_sc_hd__clkbuf_1 _0905_ (.A(_0451_),
    .X(_0153_));
 sky130_fd_sc_hd__dfxtp_1 _0906_ (.CLK(w_clk),
    .D(_0000_),
    .Q(\mem[5][0] ));
 sky130_fd_sc_hd__dfxtp_1 _0907_ (.CLK(w_clk),
    .D(_0001_),
    .Q(\mem[5][1] ));
 sky130_fd_sc_hd__dfxtp_1 _0908_ (.CLK(w_clk),
    .D(_0002_),
    .Q(\mem[5][2] ));
 sky130_fd_sc_hd__dfxtp_1 _0909_ (.CLK(w_clk),
    .D(_0003_),
    .Q(\mem[5][3] ));
 sky130_fd_sc_hd__dfxtp_1 _0910_ (.CLK(w_clk),
    .D(_0004_),
    .Q(\mem[5][4] ));
 sky130_fd_sc_hd__dfxtp_1 _0911_ (.CLK(w_clk),
    .D(_0005_),
    .Q(\mem[5][5] ));
 sky130_fd_sc_hd__dfxtp_1 _0912_ (.CLK(w_clk),
    .D(_0006_),
    .Q(\mem[5][6] ));
 sky130_fd_sc_hd__dfxtp_1 _0913_ (.CLK(w_clk),
    .D(_0007_),
    .Q(\mem[5][7] ));
 ...
 sky130_fd_sc_hd__dfxtp_1 _0921_ (.CLK(net29),
    .D(_0015_),
    .Q(net23));
 sky130_fd_sc_hd__dfxtp_1 _0922_ (.CLK(w_clk),
    .D(_0016_),
    .Q(\mem[14][0] ));
 sky130_fd_sc_hd__dfxtp_1 _0923_ (.CLK(w_clk),
    .D(_0017_),
    .Q(\mem[14][1] ));
 sky130_fd_sc_hd__dfxtp_1 _0924_ (.CLK(w_clk),
    .D(_0018_),
    .Q(\mem[14][2] ));
 sky130_fd_sc_hd__dfxtp_1 _0925_ (.CLK(w_clk),
    .D(_0019_),
    .Q(\mem[14][3] ));
 sky130_fd_sc_hd__dfxtp_1 _0926_ (.CLK(w_clk),
    .D(_0020_),
    .Q(\mem[14][4] ));
 sky130_fd_sc_hd__dfxtp_1 _0927_ (.CLK(w_clk),
    .D(_0021_),
    .Q(\mem[14][5] ));
 sky130_fd_sc_hd__dfxtp_1 _0928_ (.CLK(w_clk),
    .D(_0022_),
    .Q(\mem[14][6] ));
 sky130_fd_sc_hd__dfxtp_1 _0929_ (.CLK(w_clk),
    .D(_0023_),
    .Q(\mem[14][7] ));
 sky130_fd_sc_hd__dfxtp_1 _0930_ (.CLK(w_clk),
    .D(_0024_),
    .Q(\mem[1][0] ));
 sky130_fd_sc_hd__dfxtp_1 _0931_ (.CLK(w_clk),
    .D(_0025_),
    .Q(\mem[1][1] ));
 sky130_fd_sc_hd__dfxtp_1 _0932_ (.CLK(w_clk),
    .D(_0026_),
    .Q(\mem[1][2] ));
 sky130_fd_sc_hd__dfxtp_1 _0933_ (.CLK(w_clk),
    .D(_0027_),
    .Q(\mem[1][3] ));
 sky130_fd_sc_hd__dfxtp_1 _0934_ (.CLK(w_clk),
    .D(_0028_),
    .Q(\mem[1][4] ));
 sky130_fd_sc_hd__dfxtp_1 _0935_ (.CLK(w_clk),
    .D(_0029_),
    .Q(\mem[1][5] ));
 sky130_fd_sc_hd__dfxtp_1 _0936_ (.CLK(w_clk),
    .D(_0030_),
    .Q(\mem[1][6] ));
 sky130_fd_sc_hd__dfxtp_1 _0937_ (.CLK(w_clk),
    .D(_0031_),
    .Q(\mem[1][7] ));
 sky130_fd_sc_hd__dfxtp_1 _0938_ (.CLK(w_clk),
    .D(_0032_),
    .Q(\mem[13][0] ));
 sky130_fd_sc_hd__dfxtp_1 _0939_ (.CLK(w_clk),
    .D(_0033_),
    .Q(\mem[13][1] ));
 sky130_fd_sc_hd__dfxtp_1 _0940_ (.CLK(w_clk),
    .D(_0034_),
    .Q(\mem[13][2] ));
 sky130_fd_sc_hd__dfxtp_1 _0941_ (.CLK(w_clk),
    .D(_0035_),
    .Q(\mem[13][3] ));
 sky130_fd_sc_hd__dfxtp_1 _0942_ (.CLK(w_clk),
    .D(_0036_),
    .Q(\mem[13][4] ));
 sky130_fd_sc_hd__dfxtp_1 _0943_ (.CLK(w_clk),
    .D(_0037_),
    .Q(\mem[13][5] ));
 sky130_fd_sc_hd__dfxtp_1 _0944_ (.CLK(w_clk),
    .D(_0038_),
    .Q(\mem[13][6] ));
 sky130_fd_sc_hd__dfxtp_1 _0945_ (.CLK(w_clk),
    .D(_0039_),
    .Q(\mem[13][7] ));
 sky130_fd_sc_hd__dfxtp_1 _0946_ (.CLK(w_clk),
    .D(_0040_),
    .Q(\mem[12][0] ));
 sky130_fd_sc_hd__dfxtp_1 _0947_ (.CLK(w_clk),
    .D(_0041_),
    .Q(\mem[12][1] ));
 sky130_fd_sc_hd__dfxtp_1 _0948_ (.CLK(w_clk),
    .D(_0042_),
    .Q(\mem[12][2] ));
 sky130_fd_sc_hd__dfxtp_1 _0949_ (.CLK(w_clk),
    .D(_0043_),
    .Q(\mem[12][3] ));
 sky130_fd_sc_hd__dfxtp_1 _0950_ (.CLK(w_clk),
    .D(_0044_),
    .Q(\mem[12][4] ));
 sky130_fd_sc_hd__dfxtp_1 _0951_ (.CLK(w_clk),
    .D(_0045_),
    .Q(\mem[12][5] ));
 sky130_fd_sc_hd__dfxtp_1 _0952_ (.CLK(w_clk),
    .D(_0046_),
    .Q(\mem[12][6] ));
 sky130_fd_sc_hd__dfxtp_1 _0953_ (.CLK(w_clk),
    .D(_0047_),
    .Q(\mem[12][7] ));
 sky130_fd_sc_hd__dfxtp_1 _0954_ (.CLK(w_clk),
    .D(_0048_),
    .Q(\mem[11][0] ));
 sky130_fd_sc_hd__dfxtp_1 _0955_ (.CLK(w_clk),
    .D(_0049_),
    .Q(\mem[11][1] ));
 sky130_fd_sc_hd__dfxtp_1 _0956_ (.CLK(w_clk),
    .D(_0050_),
    .Q(\mem[11][2] ));
 sky130_fd_sc_hd__dfxtp_1 _0957_ (.CLK(w_clk),
    .D(_0051_),
    .Q(\mem[11][3] ));
 sky130_fd_sc_hd__dfxtp_1 _0958_ (.CLK(w_clk),
    .D(_0052_),
    .Q(\mem[11][4] ));
 sky130_fd_sc_hd__dfxtp_1 _0959_ (.CLK(w_clk),
    .D(_0053_),
    .Q(\mem[11][5] ));
 sky130_fd_sc_hd__dfxtp_1 _0960_ (.CLK(w_clk),
    .D(_0054_),
    .Q(\mem[11][6] ));
 sky130_fd_sc_hd__dfxtp_1 _0961_ (.CLK(w_clk),
    .D(_0055_),
    .Q(\mem[11][7] ));
 sky130_fd_sc_hd__dfxtp_1 _0962_ (.CLK(w_clk),
    .D(_0056_),
    .Q(\mem[10][0] ));
 sky130_fd_sc_hd__dfxtp_1 _0963_ (.CLK(w_clk),
    .D(_0057_),
    .Q(\mem[10][1] ));
 sky130_fd_sc_hd__dfxtp_1 _0964_ (.CLK(w_clk),
    .D(_0058_),
    .Q(\mem[10][2] ));
 sky130_fd_sc_hd__dfxtp_1 _0965_ (.CLK(w_clk),
    .D(_0059_),
    .Q(\mem[10][3] ));
 sky130_fd_sc_hd__dfxtp_1 _0966_ (.CLK(w_clk),
    .D(_0060_),
    .Q(\mem[10][4] ));
 sky130_fd_sc_hd__dfxtp_1 _0967_ (.CLK(w_clk),
    .D(_0061_),
    .Q(\mem[10][5] ));
 sky130_fd_sc_hd__dfxtp_1 _0968_ (.CLK(w_clk),
    .D(_0062_),
    .Q(\mem[10][6] ));
 sky130_fd_sc_hd__dfxtp_1 _0969_ (.CLK(w_clk),
    .D(_0063_),
    .Q(\mem[10][7] ));
 sky130_fd_sc_hd__dfxtp_1 _0970_ (.CLK(w_clk),
    .D(_0064_),
    .Q(\mem[0][0] ));
 sky130_fd_sc_hd__dfxtp_1 _0971_ (.CLK(w_clk),
    .D(_0065_),
    .Q(\mem[0][1] ));
 sky130_fd_sc_hd__dfxtp_1 _0972_ (.CLK(w_clk),
    .D(_0066_),
    .Q(\mem[0][2] ));
 sky130_fd_sc_hd__dfxtp_1 _0973_ (.CLK(w_clk),
    .D(_0067_),
    .Q(\mem[0][3] ));
 sky130_fd_sc_hd__dfxtp_1 _0974_ (.CLK(w_clk),
    .D(_0068_),
    .Q(\mem[0][4] ));
 sky130_fd_sc_hd__dfxtp_1 _0975_ (.CLK(w_clk),
    .D(_0069_),
    .Q(\mem[0][5] ));
 sky130_fd_sc_hd__dfxtp_1 _0976_ (.CLK(w_clk),
    .D(_0070_),
    .Q(\mem[0][6] ));
 sky130_fd_sc_hd__dfxtp_1 _0977_ (.CLK(w_clk),
    .D(_0071_),
    .Q(\mem[0][7] ));
 sky130_fd_sc_hd__dfxtp_1 _0978_ (.CLK(w_clk),
    .D(_0072_),
    .Q(\mem[2][0] ));
 sky130_fd_sc_hd__dfxtp_1 _0979_ (.CLK(w_clk),
    .D(_0073_),
    .Q(\mem[2][1] ));
 sky130_fd_sc_hd__dfxtp_1 _0980_ (.CLK(w_clk),
    .D(_0074_),
    .Q(\mem[2][2] ));
 sky130_fd_sc_hd__dfxtp_1 _0981_ (.CLK(w_clk),
    .D(_0075_),
    .Q(\mem[2][3] ));
 sky130_fd_sc_hd__dfxtp_1 _0982_ (.CLK(w_clk),
    .D(_0076_),
    .Q(\mem[2][4] ));
 sky130_fd_sc_hd__dfxtp_1 _0983_ (.CLK(w_clk),
    .D(_0077_),
    .Q(\mem[2][5] ));
 sky130_fd_sc_hd__dfxtp_1 _0984_ (.CLK(w_clk),
    .D(_0078_),
    .Q(\mem[2][6] ));
 sky130_fd_sc_hd__dfxtp_1 _0985_ (.CLK(w_clk),
    .D(_0079_),
    .Q(\mem[2][7] ));
 sky130_fd_sc_hd__dfxtp_1 _0986_ (.CLK(w_clk),
    .D(_0080_),
    .Q(\mem[8][0] ));
 sky130_fd_sc_hd__dfxtp_1 _0987_ (.CLK(w_clk),
    .D(_0081_),
    .Q(\mem[8][1] ));
 sky130_fd_sc_hd__dfxtp_1 _0988_ (.CLK(w_clk),
    .D(_0082_),
    .Q(\mem[8][2] ));
 sky130_fd_sc_hd__dfxtp_1 _0989_ (.CLK(w_clk),
    .D(_0083_),
    .Q(\mem[8][3] ));
 sky130_fd_sc_hd__dfxtp_1 _0990_ (.CLK(w_clk),
    .D(_0084_),
    .Q(\mem[8][4] ));
 sky130_fd_sc_hd__dfxtp_1 _0991_ (.CLK(w_clk),
    .D(_0085_),
    .Q(\mem[8][5] ));
 sky130_fd_sc_hd__dfxtp_1 _0992_ (.CLK(w_clk),
    .D(_0086_),
    .Q(\mem[8][6] ));
 sky130_fd_sc_hd__dfxtp_1 _0993_ (.CLK(w_clk),
    .D(_0087_),
    .Q(\mem[8][7] ));
 sky130_fd_sc_hd__dfxtp_1 _0994_ (.CLK(w_clk),
    .D(_0088_),
    .Q(\mem[7][0] ));
 sky130_fd_sc_hd__dfxtp_1 _0995_ (.CLK(w_clk),
    .D(_0089_),
    .Q(\mem[7][1] ));
 sky130_fd_sc_hd__dfxtp_1 _0996_ (.CLK(w_clk),
    .D(_0090_),
    .Q(\mem[7][2] ));
 sky130_fd_sc_hd__dfxtp_1 _0997_ (.CLK(w_clk),
    .D(_0091_),
    .Q(\mem[7][3] ));
 sky130_fd_sc_hd__dfxtp_1 _0998_ (.CLK(w_clk),
    .D(_0092_),
    .Q(\mem[7][4] ));
 sky130_fd_sc_hd__dfxtp_1 _0999_ (.CLK(w_clk),
    .D(_0093_),
    .Q(\mem[7][5] ));
 sky130_fd_sc_hd__dfxtp_1 _1000_ (.CLK(w_clk),
    .D(_0094_),
    .Q(\mem[7][6] ));
 sky130_fd_sc_hd__dfxtp_1 _1001_ (.CLK(w_clk),
    .D(_0095_),
    .Q(\mem[7][7] ));
 sky130_fd_sc_hd__dfxtp_1 _1002_ (.CLK(w_clk),
    .D(_0096_),
    .Q(\mem[3][0] ));
 sky130_fd_sc_hd__dfxtp_1 _1003_ (.CLK(w_clk),
    .D(_0097_),
    .Q(\mem[3][1] ));
 sky130_fd_sc_hd__dfxtp_1 _1004_ (.CLK(w_clk),
    .D(_0098_),
    .Q(\mem[3][2] ));
 sky130_fd_sc_hd__dfxtp_1 _1005_ (.CLK(w_clk),
    .D(_0099_),
    .Q(\mem[3][3] ));
 sky130_fd_sc_hd__dfxtp_1 _1006_ (.CLK(w_clk),
    .D(_0100_),
    .Q(\mem[3][4] ));
 sky130_fd_sc_hd__dfxtp_1 _1007_ (.CLK(w_clk),
    .D(_0101_),
    .Q(\mem[3][5] ));
 sky130_fd_sc_hd__dfxtp_1 _1008_ (.CLK(w_clk),
    .D(_0102_),
    .Q(\mem[3][6] ));
 sky130_fd_sc_hd__dfxtp_1 _1009_ (.CLK(w_clk),
    .D(_0103_),
    .Q(\mem[3][7] ));
 sky130_fd_sc_hd__dfxtp_1 _1010_ (.CLK(w_clk),
    .D(_0104_),
    .Q(\mem[6][0] ));
 sky130_fd_sc_hd__dfxtp_1 _1011_ (.CLK(w_clk),
    .D(_0105_),
    .Q(\mem[6][1] ));
 sky130_fd_sc_hd__dfxtp_1 _1012_ (.CLK(w_clk),
    .D(_0106_),
    .Q(\mem[6][2] ));
 sky130_fd_sc_hd__dfxtp_1 _1013_ (.CLK(w_clk),
    .D(_0107_),
    .Q(\mem[6][3] ));
 sky130_fd_sc_hd__dfxtp_1 _1014_ (.CLK(w_clk),
    .D(_0108_),
    .Q(\mem[6][4] ));
 sky130_fd_sc_hd__dfxtp_1 _1015_ (.CLK(w_clk),
    .D(_0109_),
    .Q(\mem[6][5] ));
 sky130_fd_sc_hd__dfxtp_1 _1016_ (.CLK(w_clk),
    .D(_0110_),
    .Q(\mem[6][6] ));
 sky130_fd_sc_hd__dfxtp_1 _1017_ (.CLK(w_clk),
    .D(_0111_),
    .Q(\mem[6][7] ));
 sky130_fd_sc_hd__dfrtp_1 _1018_ (.CLK(w_clk),
    .D(_0112_),
    .RESET_B(net27),
    .Q(\w_ptr_g[0] ));
 sky130_fd_sc_hd__dfrtp_1 _1019_ (.CLK(w_clk),
    .D(_0113_),
    .RESET_B(net27),
    .Q(\w_ptr_g[1] ));
 sky130_fd_sc_hd__dfrtp_1 _1020_ (.CLK(w_clk),
    .D(_0114_),
    .RESET_B(net27),
    .Q(\w_ptr_g[2] ));
 sky130_fd_sc_hd__dfrtp_1 _1021_ (.CLK(w_clk),
    .D(_0115_),
    .RESET_B(net27),
    .Q(\w_ptr_g[3] ));
 sky130_fd_sc_hd__dfrtp_1 _1022_ (.CLK(w_clk),
    .D(_0116_),
    .RESET_B(net27),
    .Q(\w_ptr_b[4] ));
 sky130_fd_sc_hd__dfxtp_1 _1023_ (.CLK(w_clk),
    .D(_0117_),
    .Q(\mem[4][0] ));
 sky130_fd_sc_hd__dfxtp_1 _1024_ (.CLK(w_clk),
    .D(_0118_),
    .Q(\mem[4][1] ));
 sky130_fd_sc_hd__dfxtp_1 _1025_ (.CLK(w_clk),
    .D(_0119_),
    .Q(\mem[4][2] ));
 sky130_fd_sc_hd__dfxtp_1 _1026_ (.CLK(w_clk),
    .D(_0120_),
    .Q(\mem[4][3] ));
 sky130_fd_sc_hd__dfxtp_1 _1027_ (.CLK(w_clk),
    .D(_0121_),
    .Q(\mem[4][4] ));
 sky130_fd_sc_hd__dfxtp_1 _1028_ (.CLK(w_clk),
    .D(_0122_),
    .Q(\mem[4][5] ));
 sky130_fd_sc_hd__dfxtp_1 _1029_ (.CLK(w_clk),
    .D(_0123_),
    .Q(\mem[4][6] ));
 sky130_fd_sc_hd__dfxtp_1 _1030_ (.CLK(w_clk),
    .D(_0124_),
    .Q(\mem[4][7] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _1040_ (.CLK(net28),
    ...
    .RESET_B(net26),
    .Q(\w_ptr_g_sync2[4] ));
 sky130_fd_sc_hd__dfrtp_1 _1041_ (.CLK(w_clk),
    .D(\r_ptr_g[0] ),
    .RESET_B(net27),
    .Q(\r_ptr_g_sync1[0] ));
 sky130_fd_sc_hd__dfrtp_1 _1042_ (.CLK(w_clk),
    .D(\r_ptr_g[1] ),
    .RESET_B(net27),
    .Q(\r_ptr_g_sync1[1] ));
 sky130_fd_sc_hd__dfrtp_1 _1043_ (.CLK(w_clk),
    .D(\r_ptr_g[2] ),
    .RESET_B(net27),
    .Q(\r_ptr_g_sync1[2] ));
 sky130_fd_sc_hd__dfrtp_1 _1044_ (.CLK(w_clk),
    .D(\r_ptr_g[3] ),
    .RESET_B(net27),
    .Q(\r_ptr_g_sync1[3] ));
 sky130_fd_sc_hd__dfrtp_1 _1045_ (.CLK(w_clk),
    .D(\r_ptr_b[4] ),
    .RESET_B(net27),
    .Q(\r_ptr_g_sync1[4] ));
 sky130_fd_sc_hd__dfrtp_1 _1046_ (.CLK(w_clk),
    .D(\r_ptr_g_sync1[0] ),
    .RESET_B(net27),
    .Q(\r_ptr_g_sync2[0] ));
 sky130_fd_sc_hd__dfrtp_1 _1047_ (.CLK(w_clk),
    .D(\r_ptr_g_sync1[1] ),
    .RESET_B(net27),
    .Q(\r_ptr_g_sync2[1] ));
 sky130_fd_sc_hd__dfrtp_1 _1048_ (.CLK(w_clk),
    .D(\r_ptr_g_sync1[2] ),
    .RESET_B(net27),
    .Q(\r_ptr_g_sync2[2] ));
 sky130_fd_sc_hd__dfrtp_1 _1049_ (.CLK(w_clk),
    .D(\r_ptr_g_sync1[3] ),
    .RESET_B(net27),
    .Q(\r_ptr_g_sync2[3] ));
 sky130_fd_sc_hd__dfrtp_1 _1050_ (.CLK(w_clk),
    .D(\r_ptr_g_sync1[4] ),
    .RESET_B(net27),
    .Q(\r_ptr_g_sync2[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1051_ (.CLK(net29),
    .D(_0125_),
    .RESET_B(net26),
    .Q(\r_ptr_b[0] ));
 ...
 sky130_fd_sc_hd__dfrtp_2 _1059_ (.CLK(net28),
    ...
    .RESET_B(net26),
    .Q(\r_ptr_b[4] ));
 sky130_fd_sc_hd__dfrtp_1 _1060_ (.CLK(w_clk),
    .D(_0134_),
    .RESET_B(net27),
    .Q(\w_ptr_b[0] ));
 sky130_fd_sc_hd__dfrtp_4 _1061_ (.CLK(w_clk),
    .D(_0135_),
    .RESET_B(net27),
    .Q(\w_ptr_b[1] ));
 sky130_fd_sc_hd__dfrtp_4 _1062_ (.CLK(w_clk),
    .D(_0136_),
    .RESET_B(net27),
    .Q(\w_ptr_b[2] ));
 sky130_fd_sc_hd__dfrtp_4 _1063_ (.CLK(w_clk),
    .D(_0137_),
    .RESET_B(net12),
    .Q(\w_ptr_b[3] ));
 sky130_fd_sc_hd__dfxtp_1 _1064_ (.CLK(w_clk),
    .D(_0138_),
    .Q(\mem[15][0] ));
 sky130_fd_sc_hd__dfxtp_1 _1065_ (.CLK(w_clk),
    .D(_0139_),
    .Q(\mem[15][1] ));
 sky130_fd_sc_hd__dfxtp_1 _1066_ (.CLK(w_clk),
    .D(_0140_),
    .Q(\mem[15][2] ));
 sky130_fd_sc_hd__dfxtp_1 _1067_ (.CLK(w_clk),
    .D(_0141_),
    .Q(\mem[15][3] ));
 sky130_fd_sc_hd__dfxtp_1 _1068_ (.CLK(w_clk),
    .D(_0142_),
    .Q(\mem[15][4] ));
 sky130_fd_sc_hd__dfxtp_1 _1069_ (.CLK(w_clk),
    .D(_0143_),
    .Q(\mem[15][5] ));
 sky130_fd_sc_hd__dfxtp_1 _1070_ (.CLK(w_clk),
    .D(_0144_),
    .Q(\mem[15][6] ));
 sky130_fd_sc_hd__dfxtp_1 _1071_ (.CLK(w_clk),
    .D(_0145_),
    .Q(\mem[15][7] ));
 sky130_fd_sc_hd__dfxtp_1 _1072_ (.CLK(w_clk),
    .D(_0146_),
    .Q(\mem[9][0] ));
 sky130_fd_sc_hd__dfxtp_1 _1073_ (.CLK(w_clk),
    .D(_0147_),
    .Q(\mem[9][1] ));
 sky130_fd_sc_hd__dfxtp_1 _1074_ (.CLK(w_clk),
    .D(_0148_),
    .Q(\mem[9][2] ));
 sky130_fd_sc_hd__dfxtp_1 _1075_ (.CLK(w_clk),
    .D(_0149_),
    .Q(\mem[9][3] ));
 sky130_fd_sc_hd__dfxtp_1 _1076_ (.CLK(w_clk),
    .D(_0150_),
    .Q(\mem[9][4] ));
 sky130_fd_sc_hd__dfxtp_1 _1077_ (.CLK(w_clk),
    .D(_0151_),
    .Q(\mem[9][5] ));
 sky130_fd_sc_hd__dfxtp_1 _1078_ (.CLK(w_clk),
    .D(_0152_),
    .Q(\mem[9][6] ));
 sky130_fd_sc_hd__dfxtp_1 _1079_ (.CLK(w_clk),
    .D(_0153_),
    .Q(\mem[9][7] ));
 ...
 sky130_fd_sc_hd__buf_1 input1 (.A(r_clk),
    .X(net1));
 sky130_fd_sc_hd__clkbuf_2 input2 (.A(r_rst_n),
    .X(net2));
 sky130_fd_sc_hd__buf_2 input3 (.A(rd),
    .X(net3));
 sky130_fd_sc_hd__buf_4 input4 (.A(w_data[0]),
    .X(net4));
 ...
 sky130_fd_sc_hd__buf_4 input11 (.A(w_data[7]),
    .X(net11));
 sky130_fd_sc_hd__dlymetal6s2s_1 input12 (.A(w_rst_n),
    .X(net12));
 ...
 sky130_fd_sc_hd__clkbuf_1 max_cap24 (.A(_0160_),
    .X(net24));
 sky130_fd_sc_hd__clkbuf_1 max_cap25 (.A(_0157_),
    .X(net25));
 sky130_fd_sc_hd__clkbuf_8 fanout26 (.A(net2),
    .X(net26));
